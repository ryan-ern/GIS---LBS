...
<body>
    <h3 class="text-white">EDIT DATA STATUS PEMESAN</h3>
    <form action="?page=Edit-Data" method="POST" class="text-white">
        ...
        ?>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="status" name="status" required onchange="updateLatitudeField()">
            ...
            <div class="form-group">
                <input type="text" class="form-control" id="latitude" name="latitude" value="<?= $data['latitude'] ?>" hidden>

                <input type="text" class="form-control" id="longitude" name="longitude" value="<?= $data['latitude'] ?>" hidden>
            </div>
